...
import { VocabularyType } from "@/app/models/vocabulary";
...
interface VocabularyState {
  // State
  queue: VocabularyType[]; // Replace 'any' with your VocabularyType
  view: View;
